...
show_menu() {
    ...
    echo "   10. Natural logarithm (ln)"
    echo "   11. Base-10 logarithm (log10)"
    echo " Other Functions:"
    echo "   12. Square root (sqrt)"
    echo "   13. Exponential (e^x)"
    echo "   14. Absolute value (|x|)"
    echo " Special Operations:"
    echo "   15. Factorial (n!)"
    echo "   16. Evaluate an expression"
    echo "   0. Exit"
    echo "================================="
}
